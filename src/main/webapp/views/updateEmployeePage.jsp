...
<div class="container">
    ...
    <form:form action="updateEmployeeDetails" method="post"
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <form:input path="empName" value="${employeeDetails.empName}"
                    class="form-control" />
                <form:errors path="empName" class="form-control" />
                <br />
            </div>
 
            <div class="form-group">
                <label class="col-form-label" for="deptName">Department
                    Name:</label>
                <form:input path="deptName" value="${employeeDetails.deptName}"
                    class="form-control" />
